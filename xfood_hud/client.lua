...
RegisterNetEvent('xfood_hud:updateStatus')
AddEventHandler('xfood_hud:updateStatus', function(status)
	SendNUIMessage({action = "updateStatus", status = status})
end)

RegisterNetEvent('xfood_hud:updateWeight')
AddEventHandler('xfood_hud:updateWeight', function(weight)
